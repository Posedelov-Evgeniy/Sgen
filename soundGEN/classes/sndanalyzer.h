...
public:
    SndAnalyzer();
    ~SndAnalyzer();
    void function_fft_top_only(GenSoundFunction fct, PlaySoundFunction pfct, VariablesFunction vfct, double t1, double t2, double freq, unsigned int points);
    void function_fft_base(GenSoundFunction fct, PlaySoundFunction pfct, VariablesFunction vfct, double t1, double t2, double freq, unsigned int points);
