...
public:
    SndAnalyzer();
    ~SndAnalyzer();
    void function_fft_top_only(GenSignalFunction fct, double t1, double t2, unsigned int points);
    void function_fft_base(GenSignalFunction fct, double t1, double t2, unsigned int points);
